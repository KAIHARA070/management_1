        ...
        <div class="card-body">
            <div class="container-fluid" id="printout">
                <div class="row mb-0">
                    ...
                    <div class="col-3 py-1 px-2 border border-navy bg-gradient-navy mb-0"><b>Assigned Technician</b></div>
                    <div class="col-9 py-1 px-2 border mb-0"><?= isset($tech_name) ? $tech_name : '' ?></div>
